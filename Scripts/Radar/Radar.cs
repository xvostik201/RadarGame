...
public class Radar : MonoBehaviour
{
    ...
    [SerializeField] private RadarButton[] _rangeButton;
    [SerializeField] private TMP_Text[] _rangeButtonText;

    [Header("Speed buttons")]
    [SerializeField] private RadarButton[] _rotationSpeedButton;
    [SerializeField] private TMP_Text[] _rotationSpeedButtonText;

    [Header("Mode buttons")]
    [SerializeField] private RadarButton[] _moveSwitchButtons;
    ...
    [SerializeField] private Missle _missleHolder;
    [SerializeField] private RadarButton _launchMissleButton;
    ...
    private void CreateOrUpdateBlip(Vector2 pos, Vector2 size, Plane plane)
    {
        ...
        Vector2 blipSize = size * _blipSizeFactor;
    ...
    private GameObject GetBlip(Plane plane)
    {
        ...
        newBlip.GetComponent<Blip>().SetBlipPlane(plane);
    ...
    {
        _radarRangeText.text = _currentRadarRange.ToString() + " KM";
    ...
    private void SetButtons()
    {
        for (int i = 0; i < _rangeButton.Length; i++)
        {
            ...
            _rangeButtonText[i].text = _radarRanges[i].ToString() + " KM";
        }
    ...
    {
        _launchMissleButton.OnButtonPressAction += () => _missleHolder.LaunchMissle(GetTrackedPlane().transform);
    }
